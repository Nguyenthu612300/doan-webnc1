   ...
   <div class="container">
     <div class="card p-4 bg-primary">
       <div class="row align-items-center">
         <div class="col" >
           <h4 class="mb-0 text-white" style="margin-left: 250px">Sản phẩm và thương hiệu tốt nhất trong cửa hàng</h4>
           <p class="mb-0 text-white-50" style="margin-left: 300px">Khám phá vẻ đẹp bản thân từ phong cách thời trang của bạn</p>
         </div>
                        ...
                        <div class="card w-100 my-2 shadow-2-strong">
                           ...
                           <div class="card-body d-flex flex-column">
                              ...
                              <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                 <a href="../product/{{$product->id}}" class="btn btn-primary shadow-0 me-1 col-md-7">Add to cart</a>
